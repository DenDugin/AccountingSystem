...
public class Record {
	...
	public  Record( TableFields recordFields, Object... o ) {      // создаем record на основе ссылки на шапку полей и массива значений полей
              ...
              //  System.out.println("recordFields.fields.size() = " + recordFields.fields.size());
...
//		if (value instanceof String)  return ((String)value).compareTo(r.Field(fieldName));	// сравниваем значения поля в двух записях, если поле типа String
//	    return 100;
//	}
